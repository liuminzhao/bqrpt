      subroutine myptdensity2(maxm, n, y, 
     &     mu, sigma,
...
c$$$Time-stamp: <liuminzhao 11/05/2012 00:11:38>
...
c         muc = myrnorm(mu, 0.1d0)
         ...
         logprioro = dnrm(mu, 0.d0, 1.d0, 1)
         logpriorc = dnrm(muc, 0.d0, 1.d0, 1)

         loglikec = 0.d0

         call loglik_unippt(n,mdzero, maxm, alpha, muc, sigma2, y,
...
C     SIGMA
         ...
         loglikec = 0.d0
         call loglik_unippt(n, mdzero, maxm, alpha, 0.d0, sigmac**2 , y, 
     &        whicho, whichn, loglikec)
...
C     ALPHA
         ...
         loglikec = 0.d0
         call loglik_unippt(n, mdzero, maxm, alphac, 0.d0, sigma2 , y, 
     &        whicho, whichn, loglikec)

         logpriorc=dgamma2(alphac, 1.d0, 30.d0,1)
         logprioro=dgamma2(alpha, 1.d0, 30.d0,1)
