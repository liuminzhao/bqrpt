...
C               if (dble(acc1(i))/dble(att1(i)) .gt. 0.25d0) then 
               if (dble(acc1(i))/dble(att1(i)) .gt. 0.2d0) then 
                  tune1(i)=tune1(i) + 
...
C               if (dble(acc2(i))/dble(att2(i)) .gt. 0.25d0) then 
               if (dble(acc2(i))/dble(att2(i)) .gt. 0.2d0) then 
                  tune2(i)=tune2(i) + 
     &                 min(0.1d0,dble(10)/sqrt(dble(iscan)))
                 else
                  tune2(i)=tune2(i)-
...
C            if (dble(acc3)/dble(att3) .gt. 0.25d0) then 
            if (dble(acc3)/dble(att3) .gt. 0.2d0) then 
               tune3=tune3 + 
...
C            if (dble(acc4)/dble(att4) .gt. 0.25d0) then 
            if (dble(acc4)/dble(att4) .gt. 0.2d0) then 
               tune4=tune4 + 
